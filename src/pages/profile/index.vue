<template>
  ...
  <div class="">
    ...
    <div class="_container flex w-full pt-16">
      ...
      <div class="fill-black hidden absolute top-[130px] left-[100px] max-md:left-[50px]"
      ...
      <div class="max-lg:flex hidden absolute top-[120px] left-2 bg-opacity-20"
        ...
        <svg height="20" width="20" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" 
        	xmlns:xlink="http://www.w3.org/1999/xlink" 
         	viewBox="0 0 185.343 185.343" xml:space="preserve">
        		<g>
        			<g>
        				<path style="fill:#3498db;" d="M51.707,185.343c-2.741,0-5.493-1.044-7.593-3.149c-4.194-4.194-4.194-10.981,0-15.175
      ...
      <div class="w-10/12 max-lg:w-11/12 pt-9 mx-auto">
        <div class="">
          <div class="px-4 py-0 "
          :class="{'py-2' : this.$route.name !== 'reports'}">
            <router-view/>
          </div>
        </div>
