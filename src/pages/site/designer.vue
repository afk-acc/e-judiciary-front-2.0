      ...
      <div class="flex">
        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30">
          <g id="doc-icon" transform="translate(-10.023 .098)">
              ...
              <path id="Path_15" data-name="Path 15" d="M19.955 35.245a2.317 2.317 0 01-1.11-.265 2 2 0 01-.771-.727 2.022 2.022 0 01-.276-1.048 1.963 1.963 0 011.048-1.774 2.317 2.317 0 011.11-.265 2.285 2.285 0 011.1.265 1.984 1.984 0 01.771.732 2.036 2.036 0 01-.771 2.816 2.285 2.285 0 01-1.101.266zm0-.777a1.269 1.269 0 00.631-.158 1.152 1.152 0 00.436-.451 1.388 1.388 0 000-1.309 1.113 1.113 0 00-.436-.445 1.3 1.3 0 00-1.262 0 1.152 1.152 0 00-.445.445 1.432 1.432 0 000 1.309 1.192 1.192 0 00.445.451 1.269 1.269 0 00.63.158z" transform="translate(1.3 -16.268)" fill="#fff"></path>
              <path id="Path_16" data-name="Path 16" d="M29.214 35.245a2.3 2.3 0 01-1.091-.259 2.008 2.008 0 01-.766-.727 2.036 2.036 0 01-.276-1.053 2 2 0 01.276-1.048 1.953 1.953 0 01.766-.727 2.431 2.431 0 012.022-.084 1.85 1.85 0 01.7.518l-.586.541a1.259 1.259 0 00-.991-.462 1.3 1.3 0 00-.654.164 1.141 1.141 0 00-.451.445 1.432 1.432 0 000 1.309 1.181 1.181 0 00.451.451 1.335 1.335 0 00.654.158 1.254 1.254 0 00.99-.471l.586.541a1.826 1.826 0 01-.7.524 2.317 2.317 0 01-.931.177z" transform="translate(-3.247 -16.268)" fill="#fff"></path>
          </g>
        </svg>
        <button class="text-link cursor-pointer" type="submit">Скачать</button>
      </div>
   </div>
    <form class="flex-wrap flex gap-x-4 max-md:mx-4 text-sm  max-lg:items-center max-lg:flex-col" >
>>>>>>> b1eb5ad8a95a6e16e696d09e37cf588f6bfc9b4f
      <div
