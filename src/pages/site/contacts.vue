<template>
  <div
      class="text-white pt-[170px] pb-[270px] relative text-center overflow-hidden before:absolute before:-z-10 before:left-0 before:top-[-17%] before:w-full before:h-full  before:-skew-y-[2.5deg] before:h-full before:bg-bg-one before:bg-left max-lg:before:bg-bottom before:bg-no-repeat before:bg-cover">
    <div class="_container mt-10">
      <div>
  ...
  <div class="_container ">
    ...
    <div class="w-7/12 flex gap-x-4 my-10">
      <div class="contact-block w-6/12 bg-white flex gap-x-4 shadow-lg px-4">
        <div class="">
        ...
        <div class="">
          <h3>Адрес</h3>
          <p>Toshkent sh., Mirobod tumani, A.Temur shohko‘chasi, 19-uy</p>
        </div>
      </div>
      <div class="contact-block w-6/12 bg-white shadow-lg">
        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Cumque debitis facere hic itaque odit provident rem
        saepe. Ad, ea, ipsum.
      </div>
    </div>
  </div>
