<template>
  ...
  >
    <div class="my-2 w-full max-md:w-8/12 max-sm:w-full">
      <v-textarea class="w-full focus:border-borderFocus focus:shadow-inputFocus" v-model:model-value="item.text" :placeholder="$t('Введите текст')" required></v-textarea>
    </div>
    <div class="">
