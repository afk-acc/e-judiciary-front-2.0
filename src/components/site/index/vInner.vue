<template>
  <div class="bg-primary_gr max-lg:px-4  w-full relative drop-shadow-2xl "  >
    <img src="/img/inner2.png" alt="" class="absolute left-0 top-0 h-full object-cover" style="filter: opacity(0.1)">
    <v-header/>
      <div class="flex pt-14 justify-between _container max-lg:flex-col max-lg:items-center  ">
        <div class="w-[49%] max-lg:w-9/12 max-lg:max-w-full max-md:text-center text-white max-w-[430px] flex justify-center flex-col">
          ...
          <div class="flex justify-between w-full max-md:flex-wrap max-md:justify-center max-md:gap-x-4 max-md:gap-y-4">
