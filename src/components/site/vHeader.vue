  ...
  <teleport to="body">
    <div
      ...
      <div class="_container flex  max-lg:flex-col items-center justify-between relative h-full">
        <div class="flex max-lg:w-9/12  h-full max-lg:w-10/12 items-center justify-between">
         <router-link to="/" class=" h-[50px] relative ">
           <img x src="/ejudiciary.svg" alt="" class="w-full h-[60px] object-cover">
         </router-link>
        ...
        :class="{'max-lg:top-[-500px]' : !openBurger, 'max-lg:top-[80px]' : openBurger}">
          ...
          <div class="flex  max-lg:flex-col gap-x-8 text-white items-center ">
            ...
            <select
                v-model="lang"
                class="text-black appearance-none text-center w-[50px] h-[50px] rounded-full focus:outline-none">
