<template>
  <div
    ...
    <div class="_container flex items-center justify-between relative h-full">
      ...
      <router-link to="/" class="w-[150px] h-[50px] relative">
      ...
      <div class="flex gap-x-8 text-white items-center ">
        <div @click="lang = lang === 'Ру'?'Uz':'Ру' ">
          {{ lang }}
        </div>
        <div class="flex gap-x-4 items-center" v-if="show()">
          <div class="header-icons flex maxsm:flex-col  items-center ">
            <div class="notification flex maxsm:py-2 items-center">
              <div class="relative">
                <div class="relative">
              ...
              <span class="flex h-4 w-4 relative">
                ...
                <div
                    ...
                    class="absolute shadow-2xl top-10 z-40 -left-[200px] maxsm:-left-[150px] maxesm:px-6 maxesm:mx-4 maxesm:flex-wrap max-h-[400px] overflow-scroll max-w-[400px] w-screen rounded-2xl bg-white py-5 flex flex-col gap-y-4">
              ...
              <router-link :to="{name:'info'}" class="flex gap-x-4 items-center">
  ...
  watch: {
    ...
    lang(val) {
      if (val === 'Uz')
        ...
        localStorage.setItem('locale', 'uz_l')
      this.switchLanguage()
    }
  }
}
